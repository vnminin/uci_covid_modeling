---
title: "Orange County, CA COVID-19 Situation Report Start Date - End Date"
...
```{r Model Structure, out.width = "70%"}
...
ggplot() +
  ...
  xlab("Date") +
  ylab(NULL) +
  theme(legend.position = c(0.12, 0.8), legend.title = element_text(size=16), legend.text = element_text(size=16), legend.background = element_rect(fill="transparent")) + 
...
death_plot <- ggplot() +
  ...
  theme(legend.position = c(0.35, 0.8), legend.title = element_text(size=16), legend.text = element_text(size=16), legend.background = element_rect(fill="transparent")) + 
  scale_fill_brewer(name="Credibility level", labels=str_c(percent(rev(ci_width))), guide = guide_legend(title.position = "top", direction = "horizontal")) +
...
ggplot() +
  ...
  xlab("Date") +
  ylab(NULL) +
  theme(legend.position = c(0.15, 0.8), legend.title = element_text(size=16), legend.text = element_text(size=16), legend.background = element_rect(fill="transparent")) +
  scale_fill_brewer(name="Credibility level", labels=str_c(percent(rev(ci_width))), guide = guide_legend(title.position = "top", direction = "horizontal")) +
