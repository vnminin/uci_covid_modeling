...
data_for_calcat <- prepped_cumulative_inc$posterior %>% 
  ...
  select(date, county, fips, cummort_mean, cummort_CI95u)

write_csv(data_for_calcat, path = "data/data_for_calcat.csv")
```
