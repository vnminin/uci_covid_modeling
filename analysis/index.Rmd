...
ggplot() +
  ...
  theme(strip.background = element_blank(),
           strip.placement = "outside", legend.position = c(0.10, 0.88), legend.title = element_text(size=16), legend.text = element_text(size=16), legend.background = element_rect(fill="transparent")) + 
...
ggplot() +
  ...
  theme(strip.background = element_blank(),
        ...
        legend.position = c(0.10, 0.88), legend.title = element_text(size=16), legend.text = element_text(size=16), legend.background = element_rect(fill="transparent")) +
  scale_fill_brewer(name="Credibility level", labels=str_c(percent(rev(ci_width))), guide = guide_legend(title.position = "top", direction = "horizontal")) +
  scale_x_date(breaks=c("12 day"), date_labels = "%b %d") +
  scale_y_continuous(labels = comma)
