---
title: "Orange County, CA COVID-19 Situation Report `r str_c(format(model_objects$actual_first_day, '%b %d'), '-', format(model_objects$actual_last_day, '%b %d'), sep = ' ')"
...
old_folder_name = "2020-06-15_2020-07-20"
...
More flashed out method description is in the [manuscript](a link). 
