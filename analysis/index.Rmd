...
param_plot <- R0 + IFR +
    plot_annotation(title = expression(paste('Prior and Posterior summaries for ', R[0], ' and IFR')),theme=theme(plot.title = element_text(hjust = 0.15)))

param_plot
```


```{r R0 over time, cache=T}
